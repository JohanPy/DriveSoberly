...
- NoMatchingViewException on views that are present manually

Practical mitigations:

- disable system animations at test setup using UiAutomation shell commands
- add explicit intermediate assertions when moving between fragments
- keep transitions deterministic with small waits only when necessary
...
- perform click failure due to visibility or focus
