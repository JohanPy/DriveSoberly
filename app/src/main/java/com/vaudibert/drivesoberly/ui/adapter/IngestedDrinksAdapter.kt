package com.vaudibert.drivesoberly.ui.adapter
...
class IngestedDrinksAdapter(
    val context: Context,
    private val ingestionService: IngestionService<com.vaudibert.drivesoberly.data.PresetDrinkEntity, IngestedDrinkEntity>,
